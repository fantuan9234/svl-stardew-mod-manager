...
use save_editor::{open_save_in_editor, save_editor_load_character, save_editor_save_character, save_editor_load_skills, save_editor_save_skills, save_editor_load_inventory, save_editor_save_inventory, save_editor_load_quests, save_editor_save_quests};
...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            save_editor_load_inventory,
            save_editor_save_inventory,
            save_editor_load_quests,
